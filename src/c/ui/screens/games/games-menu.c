...
static void menu_cell_game_large_draw(GContext* ctx, const Layer *cell_layer, bool selected, const Game *game) {
    ...
    graphics_draw_text(ctx, game->team1.score, font_bold, team_1_score_bounds, GTextOverflowModeTrailingEllipsis, GTextAlignmentLeft, NULL);
    ...
    graphics_draw_text(ctx, game->team2.score, font_bold, team_2_score_bounds, GTextOverflowModeTrailingEllipsis, GTextAlignmentLeft, NULL);
    ...
    graphics_draw_text(ctx, game->time, font_regular, time_bounds, GTextOverflowModeTrailingEllipsis, GTextAlignmentLeft, NULL);
